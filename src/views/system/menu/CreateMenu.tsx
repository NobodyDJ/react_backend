...
import { Modal, Form, TreeSelect, Input, Select, InputNumber, Radio, App } from 'antd'
import { MenuType, User } from '@/types/api'
import { useForm } from 'antd/es/form/Form'
import api from '@/api'
import { InfoCircleOutlined } from '@ant-design/icons'

export default function CreateMenu(props: IModalProp<MenuType.EditParams>) {
  const [form] = useForm()
  ...
  // 打开弹框函数
  const open = (type: IAction, data?: MenuType.EditParams | { parentId: string }) => {
    setAction(type)
    setVisible(true)
    getMenuList()
    if (data) {
